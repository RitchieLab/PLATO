...
inline double DoubDif(double a, double b)
{
	double c = Abs(a);
	double d = Abs(b);
...
inline float FloatDif(float a, float b)
{
	float c = Abs(a);
	float d = Abs(b);
...
inline bool double_comp(double a, double b){
...
inline bool dLessOrEqual(double a, double b){
	if(double_comp(a, b)){
		return true;
	}
	if(a < b){
...
inline bool dGreaterOrEqual(double a, double b){
	if(double_comp(a, b)){
		return true;
	}
	if(a > b){
...
inline bool isAlphaNum( string s ){
...
inline void printFamsToDigit(vector<Methods::Family*>* families, string name, StepOptions options){
...
inline void remapFamsToDigit(vector<Methods::Family*>* families){
	for(unsigned int i = 0; i < families->size(); i++){
		Methods::Family* fam = (*families)[i];
		fam->setFamDigit(i + 1);
...
inline bool isValidMarker(Methods::Marker* mark, StepOptions* options, int& prev_base, int& prev_chrom){
	if(mark->isEnabled()){
		if(options->doChrom()){
...
inline vector<Methods::Marker*> findValidMarkers(vector<Methods::Marker*>* marks, StepOptions options){
	int prev_base = 0;
	int prev_chrom = -1;
...
inline vector<Methods::Marker*> findRandomMarkers(vector<Methods::Marker*> good_markers, vector<Methods::Marker*>* used_markers, StepOptions* options){
...
inline void readCovariateFile(string file, DataSet* ds, StepOptions options, InputFilter* filters){
...
inline void readTraitFile(string file, DataSet* ds, StepOptions options, InputFilter* filters){
	map<string, Methods::Sample*> smap;
	map<string, Methods::Sample*>::iterator siter;
...
inline void readCovariates(string file, vector<Methods::Sample*>* samples, vector<string>* covheaders){
	map<string, Methods::Sample*> smap;
	map<string, Methods::Sample*>::iterator siter;
 ...
 *
 */
inline bool readString(FILE* fp, string* s){
    bool done = false;
    *s="";
    while (1)
    {
...
inline void readZeroGenoFile(string file){
 ...
 *
 */
inline void zeroSingleGenos(vector<Methods::Marker*>* markers, vector<Methods::Sample*>* samples){
 ...
 *
 */
inline void assignLinks(vector<Methods::Family*>* families){
 ...
 *
 */
inline void reorderAlleles(vector<Methods::Sample*>* samples, vector<Methods::Marker*>* markers){
 ...
 */
inline string map_allele(Methods::Marker* mark, string a, StepOptions *options){
 ...
 * Column2 = To column
 */
inline map<string, string> readCustomAlleles(string f){
	...
	while(getline(PED, line)){
		vector<string> tokens = General::ParseDelimitedLine(line);
		if(tokens.size() != 2){
			opts::printLog("Custom allele mapping file column size != 2: " + line + " Exitting!!\n");
			exit(0);
		}
		from = tokens[0];
		to = tokens[1];
 ...
 *
 */
inline void remapSamples(vector<Methods::Sample*>* samples, vector<Methods::Marker*>* markers, vector<int>* marker_map, int loc){
 ...
 */
inline void readPedM(vector<Methods::Sample*>* samples, vector<Methods::Family*>* families, vector<Methods::Marker*>* markers, vector<int>* marker_map, StepOptions options){
 ...
 */
inline string removeBeginWhiteSpace(string l){
	if(l.size() == 0){
		return l;
	}
 ...
 * return: void
 */
inline void readSampleFile(string file, vector<Methods::Sample*>* mlist){
	if(mlist == NULL){
 ...
 * return: void
 */
inline void readFamilyFile(string file, vector<Methods::Family*>* mlist){
	if(mlist == NULL){
...
inline void readCovTraitFile(string file, vector<string>* list){
	if(list == NULL){
 ...
 * return: void
 */
inline void readLocusFile(string file, vector<Methods::Marker*>* mlist){
	if(mlist == NULL){
...
inline map<string, float> readFreqFile(string file){
...
inline void readMapM(DataSet* ds, StepOptions options,  InputFilter* filters){
 ...
 *
 */
inline void readMapM(DataSet* ds, StepOptions options){
 ...
 *
 */
inline void readMapM(vector<Methods::Marker*>* markers, vector<int>* marker_map, StepOptions options){
	map<string, vector<string> > descinfo;
	vector<string> descheaders;
	//vector<string> exclude;
	//vector<string> include;
...
inline void readTPedM(DataSet* ds, StepOptions options){
...
inline void readTFamM(vector<Methods::Sample*>* samples, vector<Methods::Family*>* families, StepOptions options, InputFilter* filters){
	map<string, vector<string> > descinfo;
...
inline void readTFamM(vector<Methods::Sample*>* samples, vector<Methods::Family*>* families, StepOptions options){
	readTFamM(samples, families, options, NULL);
}

inline void readTFamM(DataSet* ds, StepOptions options, InputFilter* filters){
	readTFamM(ds->get_samples(), ds->get_families(), options, filters);
}

inline void readTFamM(DataSet* ds, StepOptions options){
 ...
 *
 */
inline void readBinM(vector<Methods::Sample*>* samples, vector<Methods::Family*>* families, vector<Methods::Marker*>* markers, vector<int>* marker_map, StepOptions options, InputFilter* filters){
	//vector<string> exclude;
...
inline void readBinM(vector<Methods::Sample*>* samples, vector<Methods::Family*>* families, vector<Methods::Marker*>* markers, vector<int>* marker_map, StepOptions options){
	readBinM(samples, families, markers, marker_map, options, NULL);
}

inline void readBinM(DataSet* ds, StepOptions options, InputFilter* filters){
	readBinM(ds->get_samples(), ds->get_families(), ds->get_markers(), ds->get_marker_map(), options, filters);
}

inline void readBinM(DataSet* ds, StepOptions options){
	readBinM(ds, options, NULL);
}

inline void readPedInfo(){
	...
	while(getline(PED, line)){
		...
		vector<string> tokens = General::ParseDelimitedLine(line);
		if(tokens.size() != 6){
			opts::printLog("Pedigree information file column size != 6: " + line + " Exitting!!\n");
			throw MethodException("Pedigree information file column size != 6: " + line + " Exitting!!\n");
		}
		fam = tokens[0];
		ind = tokens[1];
		dad = tokens[2];
 ...
 *
 */
inline void readPedM_3vec(vector<Methods::Sample*>* samples, vector<Methods::Family*>* families, vector<Methods::Marker*>* markers, vector<int>* marker_map, StepOptions options){
	map<string, vector<string> > descinfo;
	vector<string> exclude;
	vector<string> inccenters;
	vector<string> sinclude;
...
inline void readMapMdr(DataSet* ds, StepOptions options,  InputFilter* filters){
	vector<Methods::Marker*>* markers = ds->get_markers();
	vector<int>* marker_map = ds->get_marker_map();
	vector<string>* covariates = ds->get_covariates();
	vector<string>* traits = ds->get_traits();
 ...
 *
 */
inline void readMdr(DataSet* set, StepOptions options, InputFilter* filters){
...
inline void readPedM_3vec_set(DataSet* set, StepOptions options, InputFilter* filters){
	bool reset_todigit = false;
	if(opts::_TODIGIT_){
		reset_todigit = true;
		opts::_TODIGIT_ = false;
...
inline void readPedM_3vec_set(DataSet* set, StepOptions options){
	if(set == NULL){
		throw MethodException("NULL DataSet structure passed to readPedM_3vec_Set...\n");
	}
...
//pulled from Plink
inline double pT(double T, double df){
	if(!realnum(T)){
		return -9;
	}
...
inline double chiprobP(double chi, double df){
	if(chi < 0){
		return -1;
	}
	double pvalue = -1;
...
inline void svdcmp(vector<vector<double> > & a,
		        vector<double> & w,
...
inline vector< vector<double> > svd_inverse(vector< vector<double> > & u){
...
inline void sizeMatrix(vector<vector<double> > &m, int r, int c){
	m.clear();
	m.resize(r);
	for(int i = 0; i < r; i++){
		m[i].resize(c,0);
...
inline void svbksb(vector<vector<double> > &u, vector<double> &w, vector<vector<double> > &v,
...
inline void multMatrix(vector<vector<double> > & a,
