	...
	for(int c = 0; c < (int)chrom_counts.size(); c++){
		if(chrom_counts[c] > 0){
			if(options.getChrom() == -1 || (options.getChrom() == (c + 1))){
				string fname1 = opts::_OUTPREFIX_ + "input_phase_chr" + getString<int>(c + 1) + options.getOut() + ".txt";//"_" + getString<int>(order) + ".txt";
				...
				fname1 = opts::_OUTPREFIX_ + "input_phase_chr" + getString<int>(c+ 1) + "_map" + options.getOut() + ".txt";//+ getString<int>(order) + ".txt";
				if(options.getOverrideOut().size() > 0){
				...
				if(!options.doTriosOnly()){
								...
								if(mark->getChrom() == (c + 1) && mark->isEnabled() && !mark->isFlagged()){
									...
									if(!mark->isMicroSat()){
										if((samp->isExcluded() && options.doZeroExcluded()) || (!samp->isEnabled() && options.doIncDisabledSamples())){
											...
											a1 += map_allele(mark, mark->getAllele1(), &options) + " ";
											a2 += map_allele(mark, mark->getAllele1(), &options) + " ";
										}
										else if(!samp->getAone(mloc) && samp->getAtwo(mloc)){
											a1 += map_allele(mark, mark->getAllele1(), &options) + " ";
											a2 += map_allele(mark, mark->getAllele2(), &options) + " ";
										}
										else if(samp->getAone(mloc) && samp->getAtwo(mloc) && !samp->getAmissing(mloc)){
											a1 += map_allele(mark, mark->getAllele2(), &options) + " ";
											a2 += map_allele(mark, mark->getAllele2(), &options) + " ";
										}
										else{
											a1 += "? ";
										...
										if((samp->isExcluded() && options.doZeroExcluded()) || (!samp->isEnabled() && options.doIncDisabledSamples())){
											...
											a1 += map_allele(mark, mark->getAllele(samp->getAbone(mloc)), &options) + " ";
											a2 += map_allele(mark, mark->getAllele(samp->getAbtwo(mloc)), &options) + " ";
										}
									}//end microsat
								}
							}
					...
					//reset flags
					for(int s = 0; s < ssize; s++){
						(*samples)[s]->setFlag(false);
					}
					//parents first
					for(int s = 0; s < ssize; s++){
						Sample* samp = (*samples)[s];
						if((samp->isEnabled() || (samp->isExcluded() && options.doIncExcludedSamples()) || (!samp->isEnabled() && options.doIncDisabledSamples())) && samp->getDad() != NULL && samp->getMom() != NULL && (samp->getDad()->isEnabled() || (samp->getDad()->isExcluded() && options.doIncExcludedSamples()) || (!samp->getDad()->isEnabled() && options.doIncDisabledSamples())) && (samp->getMom()->isEnabled() || (samp->getMom()->isExcluded() && options.doIncExcludedSamples()) || (!samp->getMom()->isEnabled() && options.doIncDisabledSamples())) && samp->getFamily()->getTotalInds() == 3){
								...
								if(mark->getChrom() == (c + 1) && mark->isEnabled() && !mark->isFlagged()){
									...
									if(!mark->isMicroSat()){
										if((dad->isExcluded() && options.doZeroExcluded()) || (!dad->isEnabled() && options.doIncDisabledSamples())){
											...
											da1 += map_allele(mark, mark->getAllele1(), &options) + " ";
											da2 += map_allele(mark, mark->getAllele1(), &options) + " ";
										}
										else if(!dad->getAone(mloc) && dad->getAtwo(mloc)){
											da1 += map_allele(mark, mark->getAllele1(), &options) + " ";
											da2 += map_allele(mark, mark->getAllele2(), &options) + " ";
										}
										else if(dad->getAone(mloc) && dad->getAtwo(mloc) && !dad->getAmissing(mloc)){
											da1 += map_allele(mark, mark->getAllele2(), &options) + " ";
											da2 += map_allele(mark, mark->getAllele2(), &options) + " ";
										}
										else{
											da1 += "? ";
										...
										if((mom->isExcluded() && options.doZeroExcluded()) || (!mom->isEnabled() && options.doIncDisabledSamples())){
											...
											ma1 += map_allele(mark, mark->getAllele1(), &options) + " ";
											ma2 += map_allele(mark, mark->getAllele1(), &options) + " ";
										}
										else if(!mom->getAone(mloc) && mom->getAtwo(mloc)){
											ma1 += map_allele(mark, mark->getAllele1(), &options) + " ";
											ma2 += map_allele(mark, mark->getAllele2(), &options) + " ";
										}
										else if(mom->getAone(mloc) && mom->getAtwo(mloc) && !mom->getAmissing(mloc)){
											ma1 += map_allele(mark, mark->getAllele2(), &options) + " ";
											ma2 += map_allele(mark, mark->getAllele2(), &options) + " ";
										}
										else{
											ma1 += "? ";
										...
										if((dad->isExcluded() && options.doZeroExcluded()) || (!dad->isEnabled() && options.doIncDisabledSamples())){
											...
											da1 += map_allele(mark, mark->getAllele(dad->getAbone(mloc)), &options) + " ";
											da2 += map_allele(mark, mark->getAllele(dad->getAbtwo(mloc)), &options) + " ";
										}
										if((mom->isExcluded() && options.doZeroExcluded()) || (!mom->isEnabled() && options.doIncDisabledSamples())){
											ma1 += "-1 ";
											ma2 += "-1 ";
											...
											ma1 += map_allele(mark, mark->getAllele(mom->getAbone(mloc)), &options) + " ";
											ma2 += map_allele(mark, mark->getAllele(mom->getAbtwo(mloc)), &options) + " ";
										}
									}//end microsat
								}
							}
