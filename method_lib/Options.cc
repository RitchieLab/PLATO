...
namespace Methods{
		 ...
		 int opts::_CHRXY_ = 25;
		 int opts::_MITO_ = 26;
		 int opts::_NUMTHREADS_ = 2;
		 int opts::_PHENO_MISS_ = -9;
		 ...
		 bool opts::_THREADS_ = false;
		 bool opts::_BINTRAIT_ = true;
         ...
         //lgen
         string opts::_LGENFILE_ = "";
         string opts::_REFERENCE_FILE_ = "";
