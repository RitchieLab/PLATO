...
namespace Methods{
class QTDTOutput{// : public Process{
	private:
		DataSet* data_set;
...
//			per_cutoff.push_back(50);
		...
		QTDTOutput(int thresh) : threshold(thresh){
//			per_cutoff.push_back(100);
//			per_cutoff.push_back(95);
//			per_cutoff.push_back(90);
//			per_cutoff.push_back(85);
...
//		};
		...
		void outputCovarFile(ofstream& qtdt, Sample* samp);
		void outputCovars(ofstream& qtdt, Sample* samp);
