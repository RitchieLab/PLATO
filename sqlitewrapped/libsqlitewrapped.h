...
m_opendbs vector. New Query objects can then reuse old connections.
	*/
	...
	//this constructor was private, but caused errors...
...
public:
	...
	bool executeb(const std::string& sql);
...
private:
	...
	//added this to store error returned by sqlite3_exec method
	char* db_error;
};
